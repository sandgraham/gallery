function Carousel(container, onShowNewPage, threshold, gap) {
    this.container = container;
    this.onShowNewPage = onShowNewPage;
...
Carousel.prototype = {
    ...
    show: function(showIndex, percent, animate){
        ...
        // if a new index, run callback
        if (this.onShowNewPage) {
            this.onShowNewPage(this.pages[showIndex]);
        }
